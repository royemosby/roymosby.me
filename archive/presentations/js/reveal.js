...
;(function (root, factory) {
  ...
  function formatEmbeddedContent() {
    const _appendParamToIframeSource = function (
      sourceAttribute,
      sourceURL,
      param
    ) {
  ...
  function getSlide(x, y) {
    const horizontalSlide = dom.wrapper.querySelectorAll(
      HORIZONTAL_SLIDES_SELECTOR
    )[x]
  ...
  function getSlideBackground(x, y) {
    ...
    const horizontalBackground = dom.wrapper.querySelectorAll(
  ...
  function onDocumentKeyDown(event) {
    ...
    if (isPaused() && !resumeKeyCodes.includes(event.keyCode)) {
      return false
    }
